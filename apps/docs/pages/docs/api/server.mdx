...
WEBHOOK_URL // is the url to which the server will send webhooks
WEBHOOK_SECRET // is the secret used to sign the webhooks
API_KEY // is the api key used to authenticate requests to the server
